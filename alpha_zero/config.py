...
class AlphaZeroConfig:
    # MCTS
    num_simulations: int = 100      # simulations per move during self-play
    ...
    # Self-play & training
    num_iterations: int = 50        # outer loops of (self-play -> train)
    ...
    dirichlet_alpha: float = 0.5    # ~10/num_actions per AlphaZero paper
